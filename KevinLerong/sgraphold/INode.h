 ...
 */
  ...
  public:
    ...
    virtual void setAnimation(const glm::mat4& m) throw(runtime_error)=0;
    ...
    virtual std::vector<util::Light> getLights(stack<glm::mat4>& modelview) throw(runtime_error)=0;
};
}
